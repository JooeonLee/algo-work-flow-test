...
```bash
git switch -c solve/week-01-swea-81303-$(git config user.name)
mkdir -p solutions/week-01/swea-81303/<본인-github-아이디>
# solutions/week-01/swea-81303/<본인-github-아이디>/Solution.java 에 풀이 작성
```
